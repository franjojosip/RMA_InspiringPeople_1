...
object PeopleRepository {
    ...
    init {
        this.inspiringPeople = getInspiringPeople()
    }
    private fun getInspiringPeople(): MutableList<InspiringPerson> {
        return mutableListOf(
            InspiringPerson(1, LocalDate.of(1973, 4, 26),
                ...
                mutableListOf("Always deliver more than expected.","Always work hard on something uncomfortably exciting."), "android.resource://ht.ferit.fjjukic.rma_lv2/drawable/larrypage"),
            InspiringPerson(2, LocalDate.of(1956, 1, 31),
                "Guido van Rossum is a Dutch programmer best known as the author of the Python programming language.",
                mutableListOf("If you decide to design your own language, there are thousands of sort of amateur language designer pitfalls.","My own perception of that is somewhat colored by where people ask my advice, which is still, of course, about changes to Python internals or at least standard libraries." ), "android.resource://ht.ferit.fjjukic.rma_lv2/drawable/guidovanrossum"),
            InspiringPerson(3, LocalDate.of(1955, 10, 28),
                ...
                mutableListOf("Don’t compare yourself with anyone in this world…if you do so, you are insulting yourself.","I choose a lazy person to do a hard job. Because a lazy person will find an easy way to do it." ), "android.resource://ht.ferit.fjjukic.rma_lv2/drawable/billgates"),
            InspiringPerson(4, LocalDate.of(1955, 6, 8),
                ...
                mutableListOf("You affect the world by what you browse.","Innovation is serendipity, so you don't know what people will make." ), "android.resource://ht.ferit.fjjukic.rma_lv2/drawable/bernerslee"),
            InspiringPerson(5, LocalDate.of(1961, 7, 4),
                "Brendan Eich developed the JavaScript, which is most widely used in HTML or browsing pages.",
                mutableListOf("Always bet on JavaScript.","The main idea with Brave is that you don't have to think about Bitcoin; you just have this frictionless payment system."), "android.resource://ht.ferit.fjjukic.rma_lv2/drawable/brendanreich"),
            InspiringPerson(6, LocalDate.of(1941, 9, 9),
                ...
                mutableListOf("UNIX is basically a simple operating system, but you have to be a genius to understand the simplicity.","C is quirky, flawed, and an enormous success."), "android.resource://ht.ferit.fjjukic.rma_lv2/drawable/dennisritchie"),
            InspiringPerson(7, LocalDate.of(1950, 12, 30),
